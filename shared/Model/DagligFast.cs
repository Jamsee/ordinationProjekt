...
public class DagligFast : Ordination {
	...
	public override double doegnDosis() {
        ...
        double aktiveOrdinationDage = (startDen - slutDen).Days;

		double gennemsnitligDoegnDosis = (MorgenDosis.antal + MiddagDosis.antal + AftenDosis.antal + NatDosis.antal) / aktiveOrdinationDage;
		
        return gennemsnitligDoegnDosis;
	}
