...
public class DataService
{
    ...
    {
        // TODO: Implement!
        Laegemiddel laegemiddel = GetLaegemidler().Single(x=>x.LaegemiddelId == laegemiddelId);
        PN NPN = new PN(startDato, slutDato, antal, laegemiddel);
        db.PNs.Add(NPN);
        return NPN;
    }
    ...
    {
        Laegemiddel laegemiddel = GetLaegemidler().Single(x => x.LaegemiddelId == laegemiddelId);
        DagligFast NDF = new DagligFast(startDato, slutDato, laegemiddel, antalMorgen, antalMiddag, antalAften, antalNat);
        // TODO: Implement!
        db.DagligFaste.Add(NDF);
    ...
    public DagligSkæv OpretDagligSkaev(int patientId, int laegemiddelId, Dosis[] doser, DateTime startDato, DateTime slutDato)
    {
        ...
        Laegemiddel laegemiddel = GetLaegemidler().Single(x => x.LaegemiddelId == laegemiddelId);
        DagligSkæv NDS = new DagligSkæv(startDato, slutDato, laegemiddel, doser);
        db.DagligSkæve.Add(NDS);
        return NDS;
    }
    //Ordination start dato,Ordination start dato slut dato 
